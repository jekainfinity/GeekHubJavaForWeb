    ...
    <div class="row" style="margin-top:10px">
        ...
        <div class="col-lg-3 ">
            ...
            <div class="col-lg-12 adminColor">
                ...
                <a href="/admin/listOfHotel" class="btn btn-primary btn-lg" role="button" style="margin-top:10px">
                    SEARCH HOTEL
                </a>
        ...
        <div class="col-lg-9 mainColor" >
            ...
            <div class="col-lg-9 col-lg-offset-1 information-blue">
                <h4 class="letter"><b>Describe:</b>
                    <c:if test="${describe == null}">
                        <div class="col-lg-4 col-lg-offset-3">
                            <a href="/admin/addSomeInformation" class="btn btn-primary btn-sm" role="button" style="margin-left:400px">
                                Add information
                            </a>
                        </div>
                    </c:if>
